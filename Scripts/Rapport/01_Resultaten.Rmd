...
kable(TabelHRSeizoen,
  caption = "Overzicht home range groottes (ha) per seizoen.")
```
...
In een laatste territorium konden we de mannelijke bever BE1012 langer dan een volledig jaar volgen. De home range van deze bever bevond zich op de Demer in de gemeente Betekom en strekte zich hoofdzakelijk uit van de brug van de Begijnendijksesteenweg tot de aan de linkeroever ter hoogte van de meander gelegen aan de Blaashoek (Fig. \@ref(fig:figterr3)). Van deze bever noteerden we `r Zendertabel$Aantal[Zendertabel$Bever=="BE1012"]` waarnemingen over een periode van `r Zendertabel$dagen[Zendertabel$Bever=="BE1012"]` dagen. De meeste locatiebepalingen van deze bever bevonden zich op de meander waar de burcht zich bevond over elk seizoen. De grootte van de home range in de wintermaanden en zomermaanden vertoonde voor deze bever dan ook weinig verschil (Tab. \@ref(tab:tabseizoenranges)).
